...
def insert_user_subscription(
    ...
    reuslt_request = insert_subscription(
        userId, status, currentPeriodEnd, subscriptionType, nbRowsMaxSubscribed
    )
...
def insert_subscription_for_connexion_callback(
    ...
    response_status: bool = insert_subscription_if_not_exist(
        userId,
        status,
        currentPeriodEnd.strftime("%Y-%m-%d %H:%M:%S.%f"),
        subscriptionType,
        nbRowsMaxSubscribed,
    )
...
def get_rows_generated(userId: str) -> bool:
    """
    List of rows generated by user
    """
