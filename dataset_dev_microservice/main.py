...
from routes.dataset_config import  dataset_config_get, dataset_config_delete, dataset_config_put
...
@app.get("/openapi-dataset-config-api.json", include_in_schema=False)
async def get_openapi_dataset_config():
    """Schéma OpenAPI restreint"""
    # Crée le schéma complet
    full_schema = get_openapi(
